...
penalty in :mod:`bybit_edge._legacy_v1.tuning.optuna_tuner`.
...
def sample_from_space(trial: Any, space: dict[str, dict[str, Any]]) -> dict[str, Any]:
    ...
    trial:
        ...
        :class:`bybit_edge._legacy_v1.tuning.optuna_tuner.OptunaTuner.objective`.
    space:
    ...
    to be handed to :class:`bybit_edge._legacy_v1.tuning.ParameterContext`.
    """
    out: dict[str, Any] = {}
