...
This package is intentionally optional: importing :mod:`bybit_edge._legacy_v1.tuning`
does NOT pull in Optuna. Only :mod:`bybit_edge._legacy_v1.tuning.optuna_tuner` requires
...
from bybit_edge._legacy_v1.tuning.spaces import SPACES, sample_from_space
