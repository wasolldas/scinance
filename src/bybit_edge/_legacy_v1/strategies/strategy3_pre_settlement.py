...
# Re-reading them on every call lets :class:`bybit_edge._legacy_v1.tuning.ParameterContext`
...
class Strategy3PreSettlement:
    ...
    def reset_position_state(self) -> None:
        ...
        preserving the warmed-up M22/M23/M24/M8 state that TRAIN exists to
