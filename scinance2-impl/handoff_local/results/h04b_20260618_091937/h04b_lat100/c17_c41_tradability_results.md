...
- **Erzeugt:** 2026-06-18T09:21:01+00:00 (UTC)
...
- **Friction-Wand:** 11 bps · **Slippage:** 4 bps · **Gesamt-Wand:** 15 bps · **Latenz:** 100 ms · **Maker-Sekundaer:** nein
...
- Beste Variante: `NET_BTCUSDT->ETHUSDT_lag3_h3` (Netto -14.93 bps, bootstrap p 1.0000)
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `NET_BTCUSDT->ETHUSDT_lag1_h1` | 1000 | 1000 | 2910 | -0.08 | -0.05 | 15.0 | -15.08 | 1.0000 | 0.9801 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag2_h2` | 2000 | 2000 | 3433 | 0.04 | 0.06 | 15.0 | -14.96 | 1.0000 | 0.1990 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag3_h3` | 3000 | 3000 | 3641 | 0.07 | 0.08 | 15.0 | -14.93 | 1.0000 | 0.1343 | nein | nein |
...
- Beste Variante: `NET_BTCUSDT->ETHUSDT_lag3_h3` (Netto -14.82 bps, bootstrap p 1.0000)
- Fenster hat Netto-Edge-Survivor (per-Fenster-FDR): nein

| Variante | Lag (ms) | Horizon (ms) | Trips | Brutto-Einfang (bps) | Brutto-voll (bps) | Wand (bps) | Netto-Edge (bps) | bootstrap p | surrogate p | FDR-sig (global) | bestanden |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `NET_BTCUSDT->ETHUSDT_lag1_h1` | 1000 | 1000 | 2770 | 0.04 | 0.06 | 15.0 | -14.96 | 1.0000 | 0.0896 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag2_h2` | 2000 | 2000 | 3322 | 0.11 | 0.12 | 15.0 | -14.89 | 1.0000 | 0.0050 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag3_h3` | 3000 | 3000 | 3527 | 0.18 | 0.19 | 15.0 | -14.82 | 1.0000 | 0.0050 | nein | nein |
