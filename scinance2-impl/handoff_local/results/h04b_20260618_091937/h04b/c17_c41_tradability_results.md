...
- **Erzeugt:** 2026-06-18T09:20:20+00:00 (UTC)
...
- **Friction-Wand:** 11 bps · **Slippage:** 4 bps · **Gesamt-Wand:** 15 bps · **Latenz:** 300 ms · **Maker-Sekundaer:** nein
...
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `NET_BTCUSDT->ETHUSDT_lag1_h1` | 1000 | 1000 | 2910 | -0.10 | -0.05 | 15.0 | -15.10 | 1.0000 | 1.0000 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag2_h2` | 2000 | 2000 | 3433 | 0.02 | 0.06 | 15.0 | -14.98 | 1.0000 | 0.3433 | nein | nein |
...
- Beste Variante: `NET_BTCUSDT->ETHUSDT_lag3_h3` (Netto -14.83 bps, bootstrap p 1.0000)
- Fenster hat Netto-Edge-Survivor (per-Fenster-FDR): nein

| Variante | Lag (ms) | Horizon (ms) | Trips | Brutto-Einfang (bps) | Brutto-voll (bps) | Wand (bps) | Netto-Edge (bps) | bootstrap p | surrogate p | FDR-sig (global) | bestanden |
|---|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| `NET_BTCUSDT->ETHUSDT_lag1_h1` | 1000 | 1000 | 2770 | 0.01 | 0.06 | 15.0 | -14.99 | 1.0000 | 0.4328 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag2_h2` | 2000 | 2000 | 3322 | 0.09 | 0.12 | 15.0 | -14.91 | 1.0000 | 0.0100 | nein | nein |
| `NET_BTCUSDT->ETHUSDT_lag3_h3` | 3000 | 3000 | 3527 | 0.17 | 0.19 | 15.0 | -14.83 | 1.0000 | 0.0050 | nein | nein |
