...
| 3 | `powershell -ExecutionPolicy Bypass -File .\scinance3-impl\handoff_local\run_wp10a.ps1` | Minuten | Kohaerenz-Matrizen Stress/Ruhe, STRESS_REL/STRESS_ABS-Fixtures, Portfolio-Nulleffekt + Selektions-Decke (Bestandsserien, Stress-Ueberlappung 0-3 Tage -- DEC-62) | Report-Verzeichnis laut Ausgabe |
| 3b | `powershell -ExecutionPolicy Bypass -File .\scinance3-impl\handoff_local\run_wp10a2.ps1` | Minuten | Wiederholung von Schritt 3 auf nachgeladenen Tagesserien bis zum STRESS_ABS-Kanon-Beginn (2020-05): Funding aus `panel_1d.funding_sum`/direktem REST-Abruf, IV aus dem REST-DVOL-Backfill (DEC-61); erwartete Stress-Ueberlappung ~25-30 Tage; Report enthaelt eine Bestand-vs-Backfill-Vergleichszeile (DEC-62) | Report-Verzeichnis laut Ausgabe |
